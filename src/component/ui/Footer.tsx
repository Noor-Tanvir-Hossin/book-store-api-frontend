...
const Footer = () => {
  return (
    <footer className="bg-white border-t mt-10">
      <div className="max-w-6xl   py-10 grid grid-cols-1 md:grid-cols-3 gap-8 text-gray-700">
        {/* Papyrus Section */}
        <div>
       <div className="flex ">
       <img src={Logo} alt="Logo" className="w-12 h-12 md:w-14 md:h-14" />
       
          <p className="text-xl md:text-xl lg:text-2xl font-extrabold mt-[6px]  ">
          Book<span className="text-[#FD6E0A]">Bridge</span>
        </p>
       </div>
          <p className=" text-sm">
          Books you’ll love. Service you’ll trust.
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-sm mt-2">Email: tanvirrobin11567@gmail.com</p>
          <p className="text-sm mt-2">Phone: (+880) 1619795490</p>
        </div>
      </div>

      {/* Bottom Section */}
      <div className="border-t pt-4 pb-6 px-4 text-center text-sm text-gray-500 flex flex-col md:flex-row justify-between items-center max-w-6xl mx-auto">
